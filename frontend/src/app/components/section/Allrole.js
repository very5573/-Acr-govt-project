        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-blue-100">
              <AdminPanelSettingsIcon className="!text-xl !text-blue-800" />
            </div>
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-xs text-slate-500">
                View and manage all role and permission records.
              </p>
            </div>
          </div>
      ...
      {loading && (
        <div className="flex min-h-64 flex-col items-center justify-center px-4 py-12 text-center">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Please wait while role records are being retrieved.
          </p>
        </div>
      )}
      ...
      {!loading && roles.length === 0 ? (
        <div className="flex min-h-64 flex-col items-center justify-center px-4 py-12 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-slate-100">
            <AdminPanelSettingsIcon className="!text-3xl !text-slate-400" />
          </div>
          ...
          <p className="mt-1 max-w-sm text-sm leading-6 text-slate-500">
            Role records will appear here after a role is created.
          </p>
        </div>
      ) : (
        !loading && (
